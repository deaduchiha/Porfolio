      ...
      <Row className="align-items-center">
        <Col xs={12} md={6} xl={7}>
          ...
          <Typewriter
            options={{
              strings: [
                "I'm Front-end-developer with demonstrated skills in building web applications using JavaScript along with React.js.",
              ],
              autoStart: true,
              loop: true,
              delay: 55,
          ...
          <button className={styles.button}>
            lets conncet <i className="bi bi-arrow-right-circle"></i>
          </button>
        </Col>
